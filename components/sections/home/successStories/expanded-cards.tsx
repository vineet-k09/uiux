          ...
          {stories.map((story: Story, i: number) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative w-55 h-100 shrink-0 overflow-hidden">
                  <motion.div
                    animate={{
                ...
                <motion.div
                  layout
                  className="absolute left-55 top-0 w-85 h-full p-6 flex flex-col gap-4"
                ...
                >
                  ...
                  <p className="text-sm opacity-80">{story.challenge}</p>
                  ...
                  <p className="text-sm opacity-80">{story.solution}</p>
                  ...
                  <p className="text-sm opacity-80">{story.result}</p>
                </motion.div>
              </motion.div>
            );
          })}
