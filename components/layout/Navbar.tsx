...
const services = [
  { id: "customer-care",  label: "Customer Care",   desc: "Support & engagement solutions" },
  { id: "data-analytics", label: "Data Analytics",  desc: "Insights from your data" },
  { id: "cloud-services", label: "Cloud Services",  desc: "Scalable cloud infrastructure" },
  { id: "cyber-security", label: "Cyber Security",  desc: "Protect your digital assets" },
  { id: "ai-automation",  label: "AI Automation",   desc: "Intelligent process automation" },
];
...
export default function Navbar() {
  ...
  const dropdown = mounted && servicesOpen && createPortal(
    <div
        ...
        <nav ref={menuRef} className="px-7 py-2 relative flex items-center">
          ...
          <ul className="absolute left-1/2 transform -translate-x-1/2 flex gap-8 items-center text-lg font-semibold">
            ...
            <li className="relative">
              <Link href="/about" className="px-4 py-2 text-white/90 hover:text-white hover:bg-white/10 rounded-md transition-all duration-300">
                ABOUT
              </Link>
            </li>
            ...
            <li
              ...
              onMouseLeave={() => setServicesOpen(false)}
            >
              <Link href="/services" className="px-4 py-2 text-white/90 hover:text-white hover:bg-white/15 rounded-md transition-all duration-300">
                SERVICES
              </Link>
            </li>
          ...
          {isOpen && (
            <div className="sm:hidden flex flex-col mt-2 gap-3 text-center text-white/90 absolute top-full left-1/2 -translate-x-1/2 w-full">
              <Link href="/about" onClick={() => setIsOpen(false)} className="py-2 hover:bg-white/10 rounded-md transition">ABOUT</Link>
              <Link href="/services" onClick={() => setIsOpen(false)} className="py-2 hover:bg-white/10 rounded-md transition">SERVICES</Link>
            </div>
          )}
