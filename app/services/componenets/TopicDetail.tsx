                    ...
                    <div className="relative z-10 space-y-3">
                      ...
                      <div className="flex flex-col md:flex-row items-stretch gap-0 text-xs">
                        ...
                        <div className="flex-1 flex flex-col items-center text-center p-3">
                          ...
                          <p className="text-[hsl(0,0%,55%)] leading-relaxed">{domain.problem}</p>
                        </div>
                        ...
                        <div className="flex-1 flex flex-col items-center text-center p-3">
                          ...
                          <p className="text-[hsl(0,0%,55%)] leading-relaxed">{domain.solution}</p>
                        </div>
                        ...
                        <div className="flex-1 flex flex-col items-center text-center p-3">
                          ...
                          <p className="text-[hsl(0,0%,55%)] leading-relaxed">{domain.impact}</p>
                        </div>
                      </div>
                    </div>
                  </motion.div>
